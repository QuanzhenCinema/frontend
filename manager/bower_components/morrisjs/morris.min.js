...
(function () {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function () {
        ...
        return h(c, a), c.prototype.init = function () {
            ...
            lineWidth: 3,
            pointSize: 4,
            lineColors: ["#9d82bf", "#CD98C2","#9C9DCF", "#afd8f8", "#edc240", "#cb4b4b", "#9440ed"],
            pointStrokeWidths: [1],
        ...
        return h(d, c), d.prototype.init = function () {
            ...
            barSizeRatio: .75,
            barGap: 3,
            barColors: ["#D5D4E7", "#9C9DCF", "#4da74d", "#afd8f8", "#edc240", "#cb4b4b", "#9440ed"],
            barOpacity: 1,
            barRadius: [0, 0, 0, 0],
            xLabelMargin: 50
        ...
        return h(d, c), d.prototype.defaults = {
            colors: ["#9D7695", "#45405B", "#9C9DCF", "#95BBD7", "#B0CCE1", "#095791", "#095085", "#083E67", "#052C48", "#042135"],
